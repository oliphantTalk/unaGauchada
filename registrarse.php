        ...
        <div class="form-group">
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
              ...
              <input type="submit" name="submit" id="submit" tabindex="4" class="form-control btn btn-responder" value="Registrarme" onclick="xajax_procesaForm(xajax.getFormValues('registro'));">
